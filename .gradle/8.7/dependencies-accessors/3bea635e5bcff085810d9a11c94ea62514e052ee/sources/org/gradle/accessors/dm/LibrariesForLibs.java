...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebasePerf</b> with value <b>21.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleFirebaseFirebasePerf</b> with value <b>1.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleFirebaseFirebasePerf() { return getVersion("googleFirebaseFirebasePerf"); }
    ...
    public static class GoogleFirebasePluginAccessors extends PluginFactory {
        private final GoogleFirebaseFirebasePluginAccessors paccForGoogleFirebaseFirebasePluginAccessors = new GoogleFirebaseFirebasePluginAccessors(providers, config);

        public GoogleFirebasePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.google.firebase.firebase</b>
         */
        public GoogleFirebaseFirebasePluginAccessors getFirebase() {
            return paccForGoogleFirebaseFirebasePluginAccessors;
        }

    }

    public static class GoogleFirebaseFirebasePluginAccessors extends PluginFactory {

        public GoogleFirebaseFirebasePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>google.firebase.firebase.perf</b> with plugin id <b>com.google.firebase.firebase-perf</b> and
         * with version reference <b>googleFirebaseFirebasePerf</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPerf() { return createPlugin("google.firebase.firebase.perf"); }
